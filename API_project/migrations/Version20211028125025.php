 ...
 */
final class Version20211028125025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fichier ADD visible VARCHAR(255) DEFAULT \'actif\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fichier DROP visible');
    }
}
